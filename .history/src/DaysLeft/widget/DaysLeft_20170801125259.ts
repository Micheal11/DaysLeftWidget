...
class DaysLeft extends WidgetBase {
    ...
    public computeDays(): number {
        ...
        const futureDate = new Date(this.DateInserted);
        // alert(typeof(this.DateInserted));
        //alert(typeof(futureDate));
        const mendixDate = new Date(futureDate.getMonth(), futureDate.getDate(), futureDate.getFullYear());
